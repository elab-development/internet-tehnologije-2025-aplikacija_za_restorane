...
export default function Home() {
  ...
  const trendingRestaurants: Restaurant[] = [
    {
      ...
      phone: "011 6903311",
      about: "Živahan ambijent i začinjeni ukusi, super za druženje.",
      recenzija: "4.5/5",
    },
    {
      id: 8,
  ...
  useEffect(() => {
    ...
    if (sortType === "rating") {
      result.sort(
        (a, b) => parseFloat(b.recenzija) - parseFloat(a.recenzija)
      );
    }
  ...
  return (
    <main className="min-h-screen bg-zinc-50 px-6 py-10">
      <div className="max-w-6xl mx-auto">
        ...
        {search ? (
          <Section title="Rezultati pretrage" data={filteredRestaurants} />
        ) : (
          <>
